  ...
  return (
    <div>
      <section className='text-gray-600 body-font overflow-hidden'>
        <button onClick={() => navigate(-1)} className='flex text-xl gap-1 md:px-32 py-5'>
        ...
        <div className='container px-5 pb-10 mx-auto'>
          {item.length === 0 ? (
            ...
            <div className='lg:w-4/5 mx-auto flex flex-wrap'>
              <img alt='ecommerce' className='lg:w-1/2 w-full  md:h-[34rem] object-contain object-center rounded' src={item.images ? item.images[0] : ""} />
              <div className='lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0'>
                <h2 className='text-sm title-font text-gray-500 tracking-widest'>{item.brand}</h2>
                <h1 className='text-gray-900 text-2xl lg:text-3xl title-font font-medium mb-1'>{item.productName}</h1>
                <div className='flex mb-4'>
                  <span className='flex items-center'>
                    ...
                    <span className='text-gray-600 ml-3'>{item.ratings} Ratings</span>
                  </span>
                ...
                <div className='flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5'>
                  <div className='flex'>
                    ...
                    <button className='border-2 border-gray-300 ml-1 bg-blue-950 rounded-full w-6 h-6 focus:outline-none'></button>
                  </div>
                ...
                <div className='flex sm:flex-row flex-col justify-between'>
                  <div className='mb-3'>
                    ...
                    <span className='text-md p-1 text-slate-700 line-through'>₹{Math.ceil(item.price / (1 - item.discountPercentage / 100))}</span>
